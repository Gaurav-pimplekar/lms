...
export async function GET(req, {params}) {
  ...
  const authError = authMiddleware(req, ["faculty", "admin"]);
  ...
  try {
    ...
    const facultyCourse = await Lecture.findOne({ _id: id });

    return NextResponse.json({ course: facultyCourse }, { status: 200 });
  } catch (error) {
